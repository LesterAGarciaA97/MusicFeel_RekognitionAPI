...
AWS.config.update({
    ...
    accessKeyId: "AKIAYRQQPAVGH55AH4YK",
    secretAccessKey: "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",
    region: "us-east-1"
...
router.post("/", (req, res) => {
    ...
    rekognition.detectFaces(params, (err, response) =>{
        ...
        if(err){
            ...
            console.log("Detected faces for: Dontbe.jpg")
